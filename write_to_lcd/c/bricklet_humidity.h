 ...
 * \ingroup BrickletHumidity
 *
 * Creates the device object \u humidity with the unique device ID \c uid and adds
 ...
 * \ingroup BrickletHumidity
 *
 * Removes the device object \u humidity from its IPConnection and destroys it.
